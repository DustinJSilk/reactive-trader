...
var App = function () {
  ...
  _createClass(App, [{
    ...
    value: function addEventListeners() {
      ...
      this.socket.on(EventType.NEW_TEST_POPULATION, function (data) {
        return _this.table.populate(data);
      });
    }
  }, {
    key: 'wait',
...
},{"./components/table":2,"babel-polyfill":4}],2:[function(require,module,exports){
'use strict';
...
var Table = function () {
  function Table() {
    ...
    this.sortable = new _tablesort2.default(this.fitnessTable, {
      descending: true
    });
  }
  ...
  _createClass(Table, [{
    ...
    value: function populate(data) {
      ...
      data.population.forEach(function (test) {
        ...
        _this.fitnessTableBody.innerHTML += fitnessTemplate;
      });
...
},{"./tablesort":3}],3:[function(require,module,exports){
'use strict';
...
_tablesort2.default.extend('number', function (item) {
...
exports.default = _tablesort2.default;

},{"tablesort":330}],4:[function(require,module,exports){
(function (global){
"use strict";
